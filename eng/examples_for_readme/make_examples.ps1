$OUT_FILE_NAME = "Examples.xlsm"

$SOURCE_FILES = ".\build\StaticRegex.bas", ".\ExamplesForReadme.bas"
...
& $scriptBuildSinglePath -outModuleName "StaticRegex"
...
try {
    ...
    $excelApp.ActiveWorkbook.SaveAs($fullOutFileName, 52)
} finally {
    $excelApp.Quit()
}