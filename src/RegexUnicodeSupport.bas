...
Public Enum StaticDataDescriptionConstant
    AST_TABLE_START = 0
    
    RANGE_TABLE_DIGIT_START = AST_TABLE_START + RegexAst.AST_TABLE_LENGTH
...
Private Sub InitializeRangeTables(ByRef t() As Long)
    ...
    t(RANGE_TABLE_NOTDIGIT_START + 0) = RegexNumericConstants.LONG_MIN
    t(RANGE_TABLE_NOTDIGIT_START + 1) = &H2F&
    t(RANGE_TABLE_NOTDIGIT_START + 2) = &H3A&
    t(RANGE_TABLE_NOTDIGIT_START + 3) = RegexNumericConstants.LONG_MAX
    
    '---------------------------------
    
    t(RANGE_TABLE_NOTWHITE_START + 0) = RegexNumericConstants.LONG_MIN
    ...
    t(RANGE_TABLE_NOTWHITE_START + 23) = RegexNumericConstants.LONG_MAX
    
    '---------------------------------
    
    t(RANGE_TABLE_NOTWORDCHAR_START + 0) = RegexNumericConstants.LONG_MIN
    ...
    t(RANGE_TABLE_NOTWORDCHAR_START + 9) = RegexNumericConstants.LONG_MAX
